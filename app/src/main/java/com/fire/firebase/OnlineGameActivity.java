...
public class OnlineGameActivity extends AppCompatActivity {
    ...
    public void GameBoardClick(View view){
        ...
        if(playerSession.length() <= 0){
            ...
            switch ((selectedImage.getId())) {
                case R.id.iv_21: selectedBlock = 1; break;
                case R.id.iv_22: selectedBlock = 2; break;
                case R.id.iv_23: selectedBlock = 3; break;

                case R.id.iv_31: selectedBlock = 4; break;
                case R.id.iv_32: selectedBlock = 5; break;
                case R.id.iv_33: selectedBlock = 6; break;

                case R.id.iv_34: selectedBlock = 7; break;
                case R.id.iv_35: selectedBlock = 8; break;
                case R.id.iv_36: selectedBlock = 9; break;
            }
    ...
    void OtherPlayer(int selectedBlock) {
        ...
        switch (selectedBlock) {
            ...
            case 7:
                selectedImage = (ImageView) findViewById(R.id.iv_34);
                break;
            case 8:
                selectedImage = (ImageView) findViewById(R.id.iv_35);
                break;
            case 9:
                selectedImage = (ImageView) findViewById(R.id.iv_36);
                break;
        }
    ...
    void ResetGame(){
        ...
        iv = (ImageView) findViewById(R.id.iv_34); iv.setImageResource(0); iv.setEnabled(true);
        iv = (ImageView) findViewById(R.id.iv_35); iv.setImageResource(0); iv.setEnabled(true);
        iv = (ImageView) findViewById(R.id.iv_36); iv.setImageResource(0); iv.setEnabled(true);
    ...
    void setEnableClick(boolean trueORfalse){
        ...
        iv = (ImageView) findViewById(R.id.iv_34); iv.setClickable(trueORfalse);
        iv = (ImageView) findViewById(R.id.iv_35); iv.setClickable(trueORfalse);
        iv = (ImageView) findViewById(R.id.iv_36); iv.setClickable(trueORfalse);
    }
}